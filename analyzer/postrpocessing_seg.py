...
def postprocess(preds, img, orig_imgs, names=names, conf=conf, iou=iou):
...
if __name__ == '__main__':
    import pickle
    with open("prepoc_inp.pkl", 'rb') as f:
        inp = pickle.load(f)
    to_cpu_1 = ([inp[0][0].cpu(),
                ([inp[0][1][0][0].cpu(), inp[0][1][0][1].cpu(), inp[0][1][0][2].cpu()],
                 inp[0][1][1].cpu(),
                 inp[0][1][2].cpu())], inp[1].cpu(), inp[2])
